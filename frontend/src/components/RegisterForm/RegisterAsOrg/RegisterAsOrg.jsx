...
const RegisterAsOrg = (props) => {
  ...
  return (
    <div className="bg-white shadow-lg shadow-primary/50 w-full p-5 rounded-lg">
        ...
        <p className="text-sm my-1">Regiser into EduForum as an Institution</p>
        <form action="">
            <InputControl 
      ...
      <p className="text-primary cursor-pointer" onClick={props.registerAsUser.bind(null, true)}>
          Register as a User
        </p>
